...
fn test_proof_aggregation() -> anyhow::Result<()> {
    ...
    */
    ...
    serde_json::to_writer(
        std::fs::File::create("data/exploration_1/proof_0.json")?,
        &proof_0,
    )?;
    ...
    serde_json::to_writer(
        std::fs::File::create("data/exploration_1/proof_1.json")?,
        &proof_1,
    )?;
    ...
    serde_json::to_writer(
        std::fs::File::create("data/exploration_1/agg_proof.json")?,
        &agg_proof,
    )?;
    ...
    serde_json::to_writer(
        std::fs::File::create("data/exploration_1/block_proof.json")?,
        &block_proof,
    )?;
